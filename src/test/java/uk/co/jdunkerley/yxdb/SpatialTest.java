...
public class SpatialTest {
    ...
    public void TestPoint() throws IOException {
        var expected = "{\"yxdbType\": \"Point\", \"coordinates\": [-96.679688, 37.230328]}";
    ...
    public void TestPoints() throws IOException {
        var expected = "{\"yxdbType\": \"MultiPoint\", \"coordinates\": [[-113.730469, 7.885147], [-113.378906, 46.679594], [-100.019531, 40.178873], [-88.769531, 49.61071], [-85.957031, 12.039321]]}";
    ...
    public void TestLine() throws IOException {
        var expected = "{\"yxdbType\": \"LineString\", \"coordinates\": [[-106.875, 42.293564], [-84.375, 41.244772], [-106.347656, 36.738884], [-85.253906, 35.173808], [-110.390625, 32.546813], [-89.472656, 29.22889]]}";
    ...
    public void TestPoly() throws IOException {
        var expected = "{\"yxdbType\": \"Polygon\", \"coordinates\": [[[-84.550781, 42.811522], [-101.25, 34.452218], [-96.855469, 43.068888], [-114.082031, 32.10119], [-119.355469, 42.55308], [-104.589844, 44.087585], [-107.402344, 47.279229], [-91.230469, 52.908902], [-84.550781, 42.811522]]]}";
    ...
    public void TestPolyWithHole() throws IOException {
        var expected = "{\"yxdbType\": \"MultiPolygon\", \"coordinates\": [[[[-88.417969, 41.508577], [-89.121094, 16.299051], [-106.875, 15.961329], [-106.171875, 42.811522], [-88.417969, 41.508577]], [[-78.75, 47.872144], [-114.257813, 47.279229], [-115.3125, 8.581021], [-80.15625, 9.102097], [-78.75, 47.872144]], [[-68.203125, 54.673831], [-70.664063, 1.406109], [-124.628906, 0.35156], [-123.574219, 53.014783], [-68.203125, 54.673831]]]]}";
    ...
    private void TestSpatial(String path, String expected) throws IOException {
        ...
        try (var reader = new YxdbReader(path)) {
            while (reader.next()) {
